...
<div class="modal" id="editUserModal" tabindex="-1" role="dialog">
    ...
    <div class="modal-header">
        ...
        <!-- Corrected close button attributes for Bootstrap 5 -->
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
    </div>
    <!-- Modal body with corrected form ids and labels -->
    <div class="modal-body">
        <form id="editUserForm">
            <div class="form-group">
                <label for="editNaam">Naam:</label>
                <input type="text" class="form-control" id="editNaam" required>
            </div>
            <div class="form-group">
                <label for="editAdres">Adres:</label>
                <input type="text" class="form-control" id="editAdres" required>
            </div>
            <div class="form-group">
                <label for="editTelefoonnummer">Telefoonnummer:</label>
                <input type="number" class="form-control" id="editTelefoonnummer" required>
            </div>
